...
const features = [
  {
    icon: <DollarSign className="h-10 w-10 text-sky-500 dark:text-sky-400" />,
  ...
  {
    icon: <PieChart className="h-10 w-10 text-blue-500 dark:text-blue-400" />,
  ...
  {
    icon: <Calendar className="h-10 w-10 text-sky-500 dark:text-sky-400" />,
  ...
  {
    icon: <TrendingUp className="h-10 w-10 text-blue-500 dark:text-blue-400" />,
  ...
  {
    icon: <Users className="h-10 w-10 text-sky-500 dark:text-sky-400" />,
...
const premiumFeatures = [
  ...
  {
    icon: <ShieldCheck className="h-10 w-10 text-amber-500 dark:text-amber-400" />,
    title: "Segurança de Nível Bancário",
    description: "Proteção robusta para seus dados financeiros com criptografia de ponta e backups automáticos."
  },
  {
    icon: <Zap className="h-10 w-10 text-amber-500 dark:text-amber-400" />,
...
const Features = () => {
  return (
    <section id="features" className="py-16 md:py-24 bg-slate-100 dark:bg-slate-900 text-slate-900 dark:text-white transition-colors duration-300">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto mb-12 md:mb-20">
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold mb-6 leading-tight">
            Recursos <span className="text-transparent bg-clip-text bg-gradient-to-r from-sky-500 to-blue-600 dark:from-sky-400 dark:to-blue-500">poderosos</span> para transformar suas finanças
          </h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
          {features.map((feature, index) => (
            <div 
              key={index} 
              className="bg-white dark:bg-slate-800 p-6 rounded-xl shadow-lg hover:shadow-blue-500/30 dark:hover:shadow-blue-500/20 transition-all duration-300 border border-slate-200 dark:border-slate-700 transform hover:-translate-y-1 flex flex-col"
            >
              ...
              <p className="text-slate-500 dark:text-slate-400 text-sm flex-grow">{feature.description}</p>
            </div>
          ))}
        </div>
        
        <div className="mt-20 md:mt-24 pt-12 md:pt-16 border-t border-slate-300 dark:border-slate-700">
          <div className="text-center max-w-3xl mx-auto mb-10 md:mb-12">
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold mb-4 text-amber-600 dark:text-amber-400">Recursos Premium para Empresas</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 max-w-4xl mx-auto">
            {premiumFeatures.map((feature, index) => (
              <div 
                key={index} 
                className="bg-gradient-to-br from-white to-slate-50 dark:from-slate-800 dark:to-slate-800/70 p-6 rounded-xl shadow-lg hover:shadow-amber-500/30 dark:hover:shadow-amber-500/20 transition-all duration-300 border border-amber-300 dark:border-amber-700/50 transform hover:-translate-y-1 flex flex-col"
              >
                <div className="mb-5 self-start">{feature.icon}</div>
                <h3 className="text-xl font-semibold mb-3 text-amber-700 dark:text-amber-300">{feature.title}</h3>
                <p className="text-slate-500 dark:text-slate-400 text-sm flex-grow">{feature.description}</p>
              </div>
            ))}
          </div>
